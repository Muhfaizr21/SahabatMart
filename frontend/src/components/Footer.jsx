    ...
    <footer className="bg-gray-900 text-gray-400 pt-16 pb-8 mt-8">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-sm leading-relaxed mb-6 max-w-xs">
              Toko elektronik terpercaya dengan produk berkualitas dan harga bersahabat untuk semua kebutuhan kamu.
            </p>
            <div className="space-y-2 text-sm">
              ...
              <div className="flex items-center gap-3">
                ...
                <span>support@sahabatmart.id</span>
              </div>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              {['Profil Saya', 'Pesanan Saya', 'Wishlist', 'Lacak Pesanan', 'Bantuan'].map(item => (
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-sm">&copy; 2024 SahabatMart. All rights reserved.</p>
