...
export default function HeroSlider() {
  ...
  useEffect(() => {
    const timer = setInterval(() => setCurrent(p => (p + 1) % sliders.length), 4500);
  ...
  return (
    <section className="relative overflow-hidden min-h-[480px] flex items-center" style={{ backgroundColor: slide.bg, transition: 'background-color 0.6s ease' }}>
      <div className="max-w-7xl mx-auto px-6 w-full">
        <div className="flex items-center gap-8 py-16">
          <div className="flex-1 z-10">
            ...
            <Link to="/shop" className="inline-flex items-center gap-2 bg-white text-gray-900 font-semibold px-8 py-3.5 rounded-lg hover:bg-gray-100 transition-all shadow-lg">
              Belanja Sekarang
