    ...
    <main className="max-w-4xl mx-auto px-6 py-12">
      ...
      <header className="mb-10">
        ...
        <div className="flex items-center gap-4 border-b border-gray-100 pb-8 mt-4">
          ...
          <div>
            <div className="font-black text-gray-900 text-base">{blog.author || 'Tim AkuGlow'}</div>
            <div className="text-xs font-bold text-blue-600 uppercase tracking-widest">AkuGlow Editor</div>
          </div>
        </div>
      </header>
