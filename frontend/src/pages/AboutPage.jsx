        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="relative z-10">
            ...
            <p className="text-lg text-gray-600 mb-8 leading-relaxed max-w-lg">
              Berawal dari mimpi sederhana di tahun 2018, AkuGlow hadir untuk menjembatani jarak antara produsen kecantikan berkualitas dan konsumen yang mencari kemudahan serta transparansi bertransaksi.
            </p>
